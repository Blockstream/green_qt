...
void uniffi_lwk_fn_method_issuancerequest_address_asset(void * ptr, void * address, RustCallStatus *out_status);
void uniffi_lwk_fn_method_issuancerequest_address_token(void * ptr, void * address, RustCallStatus *out_status);
...
void uniffi_lwk_fn_method_reissuancerequest_asset_receiver(void * ptr, void * address, RustCallStatus *out_status);
...
RustBuffer uniffi_lwk_fn_func_get_path(void * network, RustBuffer account_type, uint32_t account_num, RustCallStatus *out_status);
...
uint16_t uniffi_lwk_checksum_func_get_path();
...
uint16_t uniffi_lwk_checksum_method_issuancerequest_address_asset();
uint16_t uniffi_lwk_checksum_method_issuancerequest_address_token();
...
uint16_t uniffi_lwk_checksum_method_reissuancerequest_asset_receiver();
