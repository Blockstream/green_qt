...
## [1.2.9] - 2023-12-18
### Added
- Support BIP21 payment with assetid

### Fixed
- Parse amount after pasting BIP21 payment
- Create AMP wallet from the home screen
...
## [1.2.8] - 2023-09-27
### Fixed
- Regression on balance update
- Duplicate entries in Transaction list
- Crash when using Jade with custom pin server
- Show correct Jade's firmware hash

## [1.2.7] - 2023-09-08
### Added
- Show fiat denominated amounts in transaction details dialog

### Fixed
- Faster login time on singlesig wallet
- Autologout works as expected
- Correctly update balances and transactions after login and restore
