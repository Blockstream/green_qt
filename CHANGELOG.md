...
- Completed swaps are no longer restored at login

### Fixed
- Stale swap status caused by updates dropped while restoring pending swaps
...
### Changed
- Updated Qt to 6.11.1
- Updated GDK to 0.77.6
- Updated LWK
